...
goog.require('cljs.core.async.impl.protocols');
cljs.core.async.impl.channels.box = (function box(val){if(typeof cljs.core.async.impl.channels.t20653 !== 'undefined')
{} else
{
/**
* @constructor
*/
cljs.core.async.impl.channels.t20653 = (function (val,box,meta20654){
this.val = val;
this.box = box;
...
cljs.core.async.impl.channels.t20653.cljs$lang$type = true;
cljs.core.async.impl.channels.t20653.cljs$lang$ctorStr = "cljs.core.async.impl.channels/t20653";
cljs.core.async.impl.channels.t20653.cljs$lang$ctorPrWriter = (function (this__4217__auto__,writer__4218__auto__,opt__4219__auto__){return cljs.core._write.call(null,writer__4218__auto__,"cljs.core.async.impl.channels/t20653");
});
cljs.core.async.impl.channels.t20653.prototype.cljs$core$IDeref$_deref$arity$1 = (function (_){var self__ = this;
var ___$1 = this;return self__.val;
});
cljs.core.async.impl.channels.t20653.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_20655){var self__ = this;
var _20655__$1 = this;return self__.meta20654;
});
cljs.core.async.impl.channels.t20653.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_20655,meta20654__$1){var self__ = this;
var _20655__$1 = this;return (new cljs.core.async.impl.channels.t20653(self__.val,self__.box,meta20654__$1));
});
cljs.core.async.impl.channels.__GT_t20653 = (function __GT_t20653(val__$1,box__$1,meta20654){return (new cljs.core.async.impl.channels.t20653(val__$1,box__$1,meta20654));
});
}
return (new cljs.core.async.impl.channels.t20653(val,box,null));
});
...
cljs.core.async.impl.channels.MMC = (function (){var obj20657 = {};return obj20657;
})();
...
{}
while(true){
var taker_20658 = self__.takes.pop();if((taker_20658 == null))
{} else
{if(cljs.core.async.impl.protocols.active_QMARK_.call(null,taker_20658))
{var take_cb_20659 = cljs.core.async.impl.protocols.commit.call(null,taker_20658);var val_20660 = (cljs.core.truth_((function (){var and__3628__auto__ = self__.buf;if(cljs.core.truth_(and__3628__auto__))
{return (cljs.core.count.call(null,self__.buf) > (0));
} else
{return and__3628__auto__;
}
})())?cljs.core.async.impl.protocols.remove_BANG_.call(null,self__.buf):null);cljs.core.async.impl.dispatch.run.call(null,((function (take_cb_20659,val_20660,taker_20658,this$__$1){
return (function (){return take_cb_20659.call(null,val_20660);
});})(take_cb_20659,val_20660,taker_20658,this$__$1))
);
} else
{}
{
...
{} else
{var putter_20661 = self__.puts.pop();if((putter_20661 == null))
{} else
{var put_handler_20662 = putter_20661.handler;var val_20663 = putter_20661.val;if(cljs.core.async.impl.protocols.active_QMARK_.call(null,put_handler_20662))
{var put_cb_20664 = cljs.core.async.impl.protocols.commit.call(null,put_handler_20662);cljs.core.async.impl.protocols.commit.call(null,handler);
cljs.core.async.impl.dispatch.run.call(null,((function (put_cb_20664,put_handler_20662,val_20663,putter_20661,_,retval,this$__$1){
return (function (){return put_cb_20664.call(null,true);
});})(put_cb_20664,put_handler_20662,val_20663,putter_20661,_,retval,this$__$1))
);
if(cljs.core.reduced_QMARK_.call(null,self__.add_BANG_.call(null,self__.buf,val_20663)))
...
{var taker_20665 = self__.takes.pop();if(cljs.core.async.impl.protocols.active_QMARK_.call(null,taker_20665))
{var take_cb_20666 = cljs.core.async.impl.protocols.commit.call(null,taker_20665);var val_20667__$1 = cljs.core.async.impl.protocols.remove_BANG_.call(null,self__.buf);cljs.core.async.impl.dispatch.run.call(null,((function (take_cb_20666,val_20667__$1,taker_20665,done_QMARK_,closed__$1,this$__$1){
return (function (){return take_cb_20666.call(null,val_20667__$1);
});})(take_cb_20666,val_20667__$1,taker_20665,done_QMARK_,closed__$1,this$__$1))
);
} else
{{
continue;
...
var putter_20668 = self__.puts.pop();if((putter_20668 == null))
{} else
{var put_handler_20669 = putter_20668.handler;var val_20670 = putter_20668.val;if(cljs.core.async.impl.protocols.active_QMARK_.call(null,put_handler_20669))
{var put_cb_20671 = cljs.core.async.impl.protocols.commit.call(null,put_handler_20669);cljs.core.async.impl.dispatch.run.call(null,((function (put_cb_20671,put_handler_20669,val_20670,putter_20668,this$__$1){
return (function (){return put_cb_20671.call(null,true);
});})(put_cb_20671,put_handler_20669,val_20670,putter_20668,this$__$1))
);
} else
{{
continue;
...
return (function() {
var G__20676 = null;
var G__20676__1 = (function (buf__$1){try{return add_BANG_.call(null,buf__$1);
}catch (e20674){var t = e20674;return cljs.core.async.impl.channels.handle.call(null,buf__$1,exh,t);
}});
var G__20676__2 = (function (buf__$1,val){try{return add_BANG_.call(null,buf__$1,val);
}catch (e20675){var t = e20675;return cljs.core.async.impl.channels.handle.call(null,buf__$1,exh,t);
}});
G__20676 = function(buf__$1,val){
switch(arguments.length){
case 1:
return G__20676__1.call(this,buf__$1);
case 2:
return G__20676__2.call(this,buf__$1,val);
}
