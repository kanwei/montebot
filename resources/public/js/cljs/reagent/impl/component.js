...
reagent.impl.component.do_render = (function do_render(c){var _STAR_current_component_STAR_29060 = reagent.impl.component._STAR_current_component_STAR_;try{reagent.impl.component._STAR_current_component_STAR_ = c;
var f = (c["cljsRender"]);var _ = ((reagent.impl.util.clj_ifn_QMARK_.call(null,f))?null:(function(){throw (new Error(("Assert failed: "+cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.pr_str.call(null,cljs.core.list(new cljs.core.Symbol("util","clj-ifn?","util/clj-ifn?",259370460,null),new cljs.core.Symbol(null,"f","f",43394975,null)))))))})());var p = (c["props"]);var res = ((((c["componentFunction"]) == null))?f.call(null,c):(function (){var argv = (p["argv"]);var n = cljs.core.count.call(null,argv);var G__29061 = n;switch (G__29061) {
case (1):
return f.call(null);
...
}finally {reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR_29060;
}});
reagent.impl.component.custom_wrapper = (function custom_wrapper(key,f){var G__29064 = (((key instanceof cljs.core.Keyword))?key.fqn:null);switch (G__29064) {
case "componentWillUnmount":
return ((function (G__29064){
...
{return (function() { 
var G__29066__delegate = function (args){var c = this;return cljs.core.apply.call(null,f,c,args);
};
...
G__29066.cljs$lang$applyTo = (function (arglist__29067){
...
{var G__29069 = f;(G__29069["__reactDontBind"] = true);
return G__29069;
} else
{return f;
}
...
reagent.impl.component.map_to_js = (function map_to_js(m){return cljs.core.reduce_kv.call(null,(function (o,k,v){var G__29071 = o;(G__29071[cljs.core.name.call(null,k)] = v);
return G__29071;
}),{},m);
});
...
return (function() { 
var G__29072__delegate = function (args){return as_component.call(null,cljs.core.apply.call(null,cljs.core.vector,res,args));
};
var G__29072 = function (var_args){
var args = null;if (arguments.length > 0) {
  args = cljs.core.array_seq(Array.prototype.slice.call(arguments, 0),0);} 
return G__29072__delegate.call(this,args);};
G__29072.cljs$lang$maxFixedArity = 0;
G__29072.cljs$lang$applyTo = (function (arglist__29073){
var args = cljs.core.seq(arglist__29073);
return G__29072__delegate(args);
});
