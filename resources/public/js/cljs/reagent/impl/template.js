...
var or__5197__auto__ = reagent.impl.template.attr_aliases.call(null,n);
...
var G__17303 = o;
(G__17303[reagent.impl.template.cached_prop_name.call(null,k)] = reagent.impl.template.to_js_val.call(null,v));
...
reagent.impl.template.set_id_class = (function set_id_class(props,p__17304){
var vec__17306 = p__17304;
var id = cljs.core.nth.call(null,vec__17306,(0),null);
var class$ = cljs.core.nth.call(null,vec__17306,(1),null);
var pid = (props["id"]);
...
var pname_17307 = reagent.impl.template.cached_prop_name.call(null,k);
if(!((pname_17307 === "key"))){
(o[pname_17307] = reagent.impl.template.convert_prop_value.call(null,v));
} else {
}
...
var G__17310 = jsprops;
(G__17310["defaultValue"] = value);

(G__17310["value"] = null);

(G__17310["onChange"] = ((function (G__17310,on_change,value){
return (function (p1__17308_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__17308_SHARP_);
});})(G__17310,on_change,value))
);
...
var G__17312 = spec;
(G__17312["componentDidUpdate"] = ((function (G__17312){
return (function (){
var c = this;
...
(G__17312["componentWillUnmount"] = ((function (G__17312){
return (function (){
var c = this;
...
var spec = {"displayName": (function (){var or__5197__auto__ = name;
if(cljs.core.truth_(or__5197__auto__)){
return or__5197__auto__;
} else {
...
return (function (p1__17313_SHARP_,p2__17314_SHARP_){
var C = this;
return reagent.impl.template.wrapped_should_update.call(null,C,p1__17313_SHARP_,p2__17314_SHARP_);
...
var vec__17316 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__17316,(0),null);
var id = cljs.core.nth.call(null,vec__17316,(1),null);
var class$ = cljs.core.nth.call(null,vec__17316,(2),null);
...
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [comp,(cljs.core.truth_((function (){var or__5197__auto__ = id;
if(cljs.core.truth_(or__5197__auto__)){
return or__5197__auto__;
} else {
...
var vec__17318 = reagent.impl.template.parse_tag.call(null,tag);
var comp = cljs.core.nth.call(null,vec__17318,(0),null);
var id_class = cljs.core.nth.call(null,vec__17318,(1),null);
...
var k_17319 = reagent.impl.template.get_key.call(null,cljs.core.meta.call(null,v));
var k_SINGLEQUOTE__17320 = (((k_17319 == null))?reagent.impl.template.get_key.call(null,cljs.core.nth.call(null,v,(1),null)):k_17319);
if((k_SINGLEQUOTE__17320 == null)){
} else {
(jsprops["key"] = k_SINGLEQUOTE__17320);
}
...
var n__6084__auto___17321 = a.length;
var i_17322 = (0);
while(true){
if((i_17322 < n__6084__auto___17321)){
(a[i_17322] = reagent.impl.template.as_component.call(null,(a[i_17322]),level_SINGLEQUOTE_));

var G__17323 = (i_17322 + (1));
i_17322 = G__17323;
continue;
} else {
}
