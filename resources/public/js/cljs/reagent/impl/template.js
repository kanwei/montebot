...
{return (function() { 
var G__28968__delegate = function (args){return cljs.core.apply.call(null,v,args);
};
...
G__28968.cljs$lang$applyTo = (function (arglist__28969){
...
{return cljs.core.reduce_kv.call(null,(function (o,k,v){var G__28971 = o;(G__28971[reagent.impl.template.cached_prop_name.call(null,k)] = reagent.impl.template.to_js_val.call(null,v));
return G__28971;
}),{},x);
} else
...
reagent.impl.template.set_id_class = (function set_id_class(props,p__28972){var vec__28974 = p__28972;var id = cljs.core.nth.call(null,vec__28974,(0),null);var class$ = cljs.core.nth.call(null,vec__28974,(1),null);var pid = (props["id"]);(props["id"] = ((!((pid == null)))?pid:id));
if((class$ == null))
{return null;
} else
...
{var objprops = cljs.core.reduce_kv.call(null,(function (o,k,v){var pname_28975 = reagent.impl.template.cached_prop_name.call(null,k);if(!((pname_28975 === "key")))
{(o[pname_28975] = reagent.impl.template.convert_prop_value.call(null,v));
} else
{}
return o;
...
var G__28978 = jsprops;(G__28978["defaultValue"] = value);
(G__28978["value"] = null);
(G__28978["onChange"] = ((function (G__28978,on_change,value){
return (function (p1__28976_SHARP_){return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__28976_SHARP_);
});})(G__28978,on_change,value))
);
return G__28978;
}
});
...
reagent.impl.template.add_input_methods = (function add_input_methods(spec){var G__28980 = spec;(G__28980["componentDidUpdate"] = ((function (G__28980){
return (function (){var c = this;return reagent.impl.template.input_did_update.call(null,c);
});})(G__28980))
);
(G__28980["componentWillUnmount"] = ((function (G__28980){
...
return (function (p1__28981_SHARP_,p2__28982_SHARP_){var C = this;return reagent.impl.template.wrapped_should_update.call(null,C,p1__28981_SHARP_,p2__28982_SHARP_);
...
reagent.impl.template.parse_tag = (function parse_tag(hiccup_tag){var vec__28984 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));var tag = cljs.core.nth.call(null,vec__28984,(0),null);var id = cljs.core.nth.call(null,vec__28984,(1),null);var class$ = cljs.core.nth.call(null,vec__28984,(2),null);var comp = ((React["DOM"])[tag]);var class_SINGLEQUOTE_ = (cljs.core.truth_(class$)?clojure.string.replace.call(null,class$,/\./," "):null);if(cljs.core.truth_(comp))
{} else
...
reagent.impl.template.get_wrapper = (function get_wrapper(tag){var vec__28986 = reagent.impl.template.parse_tag.call(null,tag);var comp = cljs.core.nth.call(null,vec__28986,(0),null);var id_class = cljs.core.nth.call(null,vec__28986,(1),null);return reagent.impl.template.wrap_component.call(null,comp,id_class,(''+cljs.core.str.cljs$core$IFn$_invoke$arity$1(tag)));
});
...
var c = reagent.impl.template.as_class.call(null,cljs.core.nth.call(null,v,(0)));var jsprops = {"level": level, "argv": v};var k_28987 = reagent.impl.template.get_key.call(null,cljs.core.meta.call(null,v));var k_SINGLEQUOTE__28988 = (((k_28987 == null))?reagent.impl.template.get_key.call(null,cljs.core.nth.call(null,v,(1),null)):k_28987);if((k_SINGLEQUOTE__28988 == null))
{} else
{(jsprops["key"] = k_SINGLEQUOTE__28988);
}
...
reagent.impl.template.expand_seq = (function expand_seq(s,level){var a = cljs.core.into_array.call(null,s);var level_SINGLEQUOTE_ = (level + (1));var n__4510__auto___28989 = a.length;var i_28990 = (0);while(true){
if((i_28990 < n__4510__auto___28989))
{(a[i_28990] = reagent.impl.template.as_component.call(null,(a[i_28990]),level_SINGLEQUOTE_));
{
var G__28991 = (i_28990 + (1));
i_28990 = G__28991;
continue;
}
} else
