...
{{
var G__180349 = cljs.core.pop.call(null,v__$1);
v__$1 = G__180349;
continue;
}
} else
...
{var pred__180353 = cljs.core._EQ_;var expr__180354 = limit;if(cljs.core.truth_(pred__180353.call(null,(1),expr__180354)))
{return (new cljs.core.PersistentVector(null,1,(5),cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__180353.call(null,(2),expr__180354)))
...
var G__180356 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__180357 = (limit__$1 - (1));
var G__180358 = cljs.core.conj.call(null,parts,s__$1.substring((0),index));
s__$1 = G__180356;
limit__$1 = G__180357;
parts = G__180358;
continue;
...
{var ch = s.charAt(index);var temp__4386__auto___180360 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4386__auto___180360))
{var replacement_180361 = temp__4386__auto___180360;buffer.append((''+cljs.core.str.cljs$core$IFn$_invoke$arity$1(replacement_180361)));
} else
{buffer.append(ch);
}
{
var G__180362 = (index + (1));
index = G__180362;
continue;
}
}
